...
# Set variables
KEY_STORE_PASSWORD=${KEY_STORE_PASSWORD:-wkfnclientdev}
...
kubeseal -n dev --controller-name=${SEALED_SECRET_CONTOLLER_NAME} --controller-namespace=${SEALED_SECRET_NAMESPACE} -o yaml < delete-wkfn-client-jks-password-secret.yaml > wkfn-client-jks-password-secret.yaml
